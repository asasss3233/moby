...
window.open_sliding_overlay_v1 = (logo_url, channel_name, subscribers_amount, description, ofu = () => {}, id, arg = null) => {
...
window.open_sliding_overlay_v2 = (logo_url, event_name, event_date, description, ofu = () => {}, id, arg) => {
    let el = document.getElementById(id)
    console.log(el.children[0])
    el.children[0].children[1].children[0].src = logo_url
    el.children[0].children[2].innerHTML = event_name
    el.children[0].children[3].innerHTML = event_date
