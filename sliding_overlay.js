...
window.open_sliding_overlay_v1 = (logo_url, channel_name, subscribers_amount, description, cards) => {
...
window.open_sliding_overlay_v2 = (logo_url, event_name, event_date, description, cards) => {
