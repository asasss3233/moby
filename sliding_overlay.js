...
function open_sliding_overlay(logo_url, channel_name, subscribers_amount, sliding_tabs_labels, text, cards) {
    // Cringe solution!!!
    ...
    document.querySelectorAll(".tab-content p")[opened_sliding_overlay_index].innerText = text

    if (opened_sliding_overlay_index === 0) {
        document.querySelectorAll(".tab-content h4")[0].innerText = sliding_tabs_labels[0]
        document.querySelectorAll(".tab-content h4")[1].innerText = sliding_tabs_labels[1]
    }
    if (opened_sliding_overlay_index === 1) {
        document.querySelectorAll(".tab-content h4")[2].innerText = sliding_tabs_labels[0]
        document.querySelectorAll(".tab-content h4")[3].innerText = sliding_tabs_labels[1]
    }
